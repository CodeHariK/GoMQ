...
import (
	...
	"github.com/codeharik/GoMQ/client"
)

var (
	categoryName    = flag.String("category", "stdin", "The category being tested")
	debug           = flag.Bool("debug", false, "Debug mode")
	ack             = flag.Bool("ack", true, "Acknowledge reads")
	minSyncReplicas = flag.Uint("min-sync-replicas", 0, "How many replicas to wait when writing a message")
	addrsFlag       = flag.String("addrs", "http://127.0.0.1:8080,http://127.0.0.1:8081,http://127.0.0.1:8082,http://127.0.0.1:8083,http://127.0.0.1:8084", "List of Chukcha servers")
)
