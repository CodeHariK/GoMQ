...
2. Run the following command in your terminal: `$ go install -v github.com/codeharik/GoMQ@latest`
...
If you really want to use Chukcha, please refer to the simple Go client library at https://pkg.go.dev/github.com/codeharik/GoMQ/client.
